          ...
          child: Column(
            children: [
              Align(
                ...
                child: IconButton(
                  icon: const Icon(Icons.arrow_back_ios_new, color: AppColors.ancientBrown),
                            ...
                            return SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  elevation: 8,
                                  shadowColor: AppColors.templeSaffron.withValues(alpha: 0.4),
                                ),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            hintText: hint,
            hintStyle: TextStyle(color: AppColors.earthyGrey.withValues(alpha: 0.5)),
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(AppSizes.radiusMd),
              borderSide: const BorderSide(color: AppColors.templeGold, width: 1.5),
            ),
            errorBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(AppSizes.radiusMd),
              borderSide: const BorderSide(color: AppColors.sacredRed, width: 1),
            ),
          ),
          validator: validator,
        ),
